...
public class StudentActivity extends AppCompatActivity {
   ...
   // Log.d("cidname", String.valueOf(cid));
    ...
    private void saveStatus() {
        for(StudentItem studentItem : studentItems)
        {
            ...
            //new SweetAlertDialog(StudentActivity.this,SweetAlertDialog.SUCCESS_TYPE)
                   // .setTitleText("Attendace Saved Successfully").show();
            Toast.makeText(StudentActivity.this,"Attendace Saved Successfully", Toast.LENGTH_SHORT).show();
